...
This document tries to address on how to use most of these slots in Sodalink Model.
...
Here we define a list of 5 predicates that are seman equivalent to the Sodalink Model predicate slot `same as`.
